...
export default function NewsItem({ news }: Props) {
  return (
    <div className="relative flex flex-col md:flex-row justify-start gap-4 rounded-xl cursor-pointer border border-gray-300
      ...
      <div className='absolute bottom-4 right-4 px-1.5 py-3.5 rounded-full bg-red-700 flex items-center justify-center
